#!/usr/bin/env python3
"""Debug what terms we actually have."""

from src.glaemscribe.parsers.mode_parser import ModeParser
from src.glaemscribe.core.rule_group import CodeLinesTerm, IfTerm

def debug_terms():
    """Debug what terms we have."""
        ...
        for name, rg in mode.rule_groups.items():
            ...
            for i, term in enumerate(rg.root_code_block.terms):
                ...
                if isinstance(term, CodeLinesTerm):
                    ...
                    for l, code_line in enumerate(term.code_lines[:5]):
